...
const SECTOR_ORDER: [u8; 20] = [20, 1, 18, 4, 13, 6, 10, 15, 2, 17, 3, 19, 7, 16, 8, 11, 14, 9, 12, 5];
...
pub fn sector_from_angle(angle: f64) -> u8 {
    ...
    let sector_index = ((normalized_angle + (SECTOR_SPAN_DEGREES / 2.0)) / SECTOR_SPAN_DEGREES).floor() as usize % SECTOR_ORDER.len();
